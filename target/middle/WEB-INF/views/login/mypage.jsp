...
<%@ include file="../common/header.jsp"%>
	...
	<main class="container mx-auto px-4 pt-24 pb-12 min-h-screen flex">
		...
		<div class="flex-1">
			<!-- 페이지 제목 -->
			<div class="mb-8">
				<h1 class="text-3xl font-bold text-gray-900">합격 이력서</h1>
				<p class="text-gray-600 mt-2">다양한 기업의 합격 이력서를 확인하고 참고하여 나만의 이력서를
					작성해보세요.</p>
			</div>
			<!-- 필터 및 정렬 -->
			<div
					...
					<div class="p-5">
						<div class="flex justify-between items-start mb-4">
							<div>
								...
								<h3 class="text-lg font-bold text-gray-900">${resume.rsname}</h3>
								</a>
						...
						<div class="space-y-2 mb-4">
							<div class="flex items-center text-sm">
								<span class="w-24 text-gray-500">합격 시기</span> <span
									class="text-gray-700">2025년 1분기</span>
							</div>
							<div class="flex items-center text-sm">
								<span class="w-24 text-gray-500">문항 수</span> <span
									class="text-gray-700">4개</span>
							</div>
							<div class="flex items-center text-sm">
						...
						<p class="text-sm text-gray-700 border-t pt-4">${resume.rscletter}</p>
					</div>
